...
echo "--- Differences $TOKENCONTRACTSDIR/$CONTROLLERSOL $CONTROLLERSOL ---" | tee -a $TEST2OUTPUT
echo "$DIFFS1" | tee -a $TEST2OUTPUT

DIFFS1=`diff $TOKENCONTRACTSDIR/$LEDGERSOL $LEDGERSOL`
echo "--- Differences $TOKENCONTRACTSDIR/$LEDGERSOL $LEDGERSOL ---" | tee -a $TEST2OUTPUT
echo "$DIFFS1" | tee -a $TEST2OUTPUT

DIFFS1=`diff $TOKENCONTRACTSDIR/$TOKENSOL $TOKENSOL`
echo "--- Differences $TOKENCONTRACTSDIR/$TOKENSOL $TOKENSOL ---" | tee -a $TEST2OUTPUT
echo "$DIFFS1" | tee -a $TEST2OUTPUT

DIFFS1=`diff $SALESCONTRACTSDIR/$RECEIVERSOL $RECEIVERSOL`
echo "--- Differences $SALESCONTRACTSDIR/$RECEIVERSOL $RECEIVERSOL ---" | tee -a $TEST2OUTPUT
echo "$DIFFS1" | tee -a $TEST2OUTPUT

DIFFS1=`diff $SALESCONTRACTSDIR/$SALESOL $SALESOL`
echo "--- Differences $SALESCONTRACTSDIR/$SALESOL $SALESOL ---" | tee -a $TEST2OUTPUT
echo "$DIFFS1" | tee -a $TEST2OUTPUT
